...
class ActivityChartWidget extends Component {
  constructor(props) {
    ...
    this.data = (canvas) => {
      ...
      gradient.addColorStop(0, Color(props.accentColor).fade(.85));
      gradient.addColorStop(1, Color(props.accentColor).fade(.95));
      return {
        labels,
        datasets: [
          {
            ...
            pointBorderWidth: 3,
            pointBorderColor: props.accentColor,
            pointHoverRadius: 4,
  ...
  render() {
    ...
    return (
      <div className="activityChart-widget stkd-widget stkd-content no-pad flex flex-col space-between">
        ...
        <div style={{ marginLeft: -10, marginBottom: -11, marginTop: 'calc(100px - 40%)' }} className="chart">
          <Line
            data={this.data}
            height={250}
            labels={this.labels}
